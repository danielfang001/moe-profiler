...
def use_dynamic_forward():
    ...
    print("✓ Switched to DYNAMIC top-k forward (tracking k and FLOPs with phase separation)")
...
def compare_k_and_flops():
    ...
    if dynamic_k_prefill:
        ...
        print(f"\n📊 K VALUES - Dynamic Top-K (Prefill):")
    ...
    if all_dynamic_k:
        ...
        print(f"\nOverall Dynamic K: {d_k_all.mean():.3f} ± {d_k_all.std():.3f}")
